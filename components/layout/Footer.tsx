                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center space-x-2 text-sm text-white/60">
                                ...
                                <a href="mailto:contact@reelrapidagency.com" className="hover:text-primary transition-colors">
                                    contact@reelrapidagency.com
                                </a>
                            </div>
                            <div className="flex items-center space-x-2 text-sm text-white/60">
                                <Phone className="w-4 h-4 text-primary" />
                                <a href="tel:+212655048286" className="hover:text-primary transition-colors">
                                    +212 655-048286
                                </a>
                            </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <input
                                ...
                                className="px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-sm text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50"
                            />
                        ...
                        {socialLinks.map((social) => {
                            ...
                            return (
                                <a
                                    key={social.name}
                                    href={social.href}
                                    className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-white/60 hover:bg-primary hover:text-white transition-all hover:scale-110"
